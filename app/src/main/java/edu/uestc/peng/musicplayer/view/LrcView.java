...
import edu.uestc.peng.musicplayer.R;
...
public class LrcView extends View implements ILrcView {
    ...
    private int mHignlightRowColor = getResources().getColor(R.color.colorHighLight);
    private int mNormalRowColor = getResources().getColor(R.color.colorNormal);
    ...
    private String mLoadingLrcTip = "Loading lrc...";
